...
* *[SANDBOX_LORE](https://github.com/Protonk/SANDBOX_LORE)* is an in-progress host-bound, local-first “live textbook” for Apple’s Seatbelt sandbox built around reproducible evidence instead of narrative authority. The aim is to make the sandbox legible end-to-end, from policy to observed behavior. About as hard as it looks.
